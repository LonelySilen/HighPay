...
var __parent0=require('$model/UI2/weixin/login'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cuMbAJf';
	this._flag_='12ef6f374316f7ee911d858ea238da5f';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":false,"autoNew":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"userId":{"define":"userId","label":"userId","name":"userId","relation":"userId","type":"String"},"userpass":{"define":"userpass","label":"userpass","name":"userpass","relation":"userpass","type":"String"}},"directDelete":false,"events":{},"idColumn":"userId","limit":20,"xid":"userData"});
 new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":false,"defCols":{"userId":{"define":"userId","label":"userId","name":"userId","relation":"userId","type":"String"},"userpass":{"define":"userpass","label":"userpass","name":"userpass","relation":"userpass","type":"String"}},"directDelete":false,"events":{"onAfterRefresh":"getRegistrationID"},"idColumn":"userId","limit":20,"xid":"temp"});
}}); 
return __result;});
