...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:135px;top:10px;"> 
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="calculateData" idColumn="allSum">
   ...
   <data xid="default8">[{&quot;allSum&quot;:&quot;0&quot;,&quot;isBack&quot;:0}]</data></div></div>  
  <span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="winRec" style="left:57px;top:12px;"></span><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card x-has-iosstatusbar"> 
    ...
    <div xid="content" class="x-panel-content x-scroll-view x-cards" supportpulldown="true"> 
      <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
        ...
        <div class="x-scroll-content" xid="div7"> 
          <div component="$UI/system/components/justep/list/list" class="x-list bg-white" data="goodsData" xid="goodsList" disablePullToRefresh="true" disableInfiniteLoad="true"> 
   ...
   <div class="x-col x-col-fixed x-col-center" xid="col1" style="width:auto;"><span component="$UI/system/components/justep/button/checkbox" class="x-checkbox x-radio choose" xid="checkbox2" bind-ref="ref('fChoose')" checkedValue="1"></span></div>
   <div class="x-col x-col-fixed tb-nopadding" xid="col2" style="width:90px;"><img src="" alt="" xid="image1" bind-attr-src='$model.getImageUrl(val("fImg"))' class="tb-img-good" bind-click="listClick"></img></div>
  ...
  <div class="text-right" xid="div10">
   <span xid="span16"><![CDATA[不含手续费]]></span></div></div>
